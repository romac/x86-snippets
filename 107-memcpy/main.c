...
void * rc_memcpy_c( void * restrict dest, const void * restrict src, size_t n )
{
...
void * rc_memcpy( void * dest, const void * src, size_t n );
...
int main( int argc, char ** argv )
{
    ...
    rc_memcpy( dest, src, strlen( src ) + 1 );
